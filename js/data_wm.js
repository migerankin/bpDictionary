var WMwhere_value  =[
    {level: 'G1', kind: '1', toGet: 'レイクリッド坑道・追加調査<br>ラッシュバトル初段<br>ラッシュバトル二段'},
    {level: 'G2', kind: '1', toGet: 'ラッシュバトル三段<br>ラッシュバトル四段'},
    {level: 'G3', kind: '1', toGet: '天恵の聖堂・追加調査<br>激闘！巨竜の爪痕<br>ラッシュバトル四段<br>EXラッシュ初段 守護者<br>修練の遺跡'},
    {level: 'G1', kind: '2', toGet: 'レイクリッド坑道・追加調査<br>暁の虫砦・追加調査<br>天恵の聖堂・追加調査<br>激闘！巨竜の爪痕<br>亢進！神懸の御柱<br>ラッシュバトル三段'},
    {level: 'G2', kind: '2', toGet: '激闘！巨竜の爪痕<br>ラッシュバトル四段'},
]
var WM_value = [
    ...
    {name: "スタンピートアロー短縮", level: "G1", xg: "スタンピートアロー・冷却时间缩短+6%～10%", kind: "2", zy: "3", imgNum: '302'},
    {name: "スタンピートアロー短縮", level: "G2", xg: "スタンピートアロー・冷却时间缩短+11%～15%", kind: "2", zy: "3", imgNum: '302'},
    ...
    {name: "ブーストスマシュ強撃", level: "G1", xg: "ブーストスマシュ・造成伤害增加+11%～15%", kind: "2", zy: "5", imgNum: '503'},
    {name: "ブーストスマシュ強撃", level: "G2", xg: "ブーストスマシュ・造成伤害增加+16%～20%", kind: "2", zy: "5", imgNum: '503'},
