...
var M_value=[
    ...
    {pid:'8092',name:'ゴーリィ<br>', monsKind:'ゴート系' ,spaceName:'西バーンハルト半島',isBoss:'小怪',mapWhere:['8200'],lessElem:'None',moreElem:'None'},
    {pid:'8093',name:'ダイアーハウル<br>', monsKind:'フォックス系' ,spaceName:'西バーンハルト半島',isBoss:'小怪',mapWhere:['8201'],lessElem:'None',moreElem:'None'},
    {pid:'8094',name:'Ｍフォックス<br>机械狐', monsKind:'フォックス系' ,spaceName:'西バーンハルト半島',isBoss:'小怪',mapWhere:['8202'],lessElem:'None',moreElem:'None'},
    {pid:'8095',name:'バーンハルト兵<br>伯恩哈特士兵', monsKind:'バーンハルト兵系' ,spaceName:'西バーンハルト半島',isBoss:'小怪',mapWhere:['8202'],lessElem:'None',moreElem:'None'},
    {pid:'8096',name:'バーンハルト騎士<br>伯恩哈特骑士', monsKind:'バーンハルト兵系' ,spaceName:'西バーンハルト半島',isBoss:'小怪',mapWhere:['8204'],lessElem:'None',moreElem:'None'},
    {pid:'8097',name:'バーンハルト狙撃兵<br>伯恩哈特狙击兵', monsKind:'バーンハルト兵系' ,spaceName:'西バーンハルト半島',isBoss:'小怪',mapWhere:['8204'],lessElem:'None',moreElem:'None'},
    {pid:'8098',name:'エビキノコパライズ<br>麻痹蘑菇虾', monsKind:'エビキノコ系' ,spaceName:'西バーンハルト半島',isBoss:'小怪',mapWhere:['8208'],lessElem:'None',moreElem:'None'},
    {pid:'8099',name:'カニクモフロスト<br>冰蛛蟹', monsKind:'カニクモ系' ,spaceName:'西バーンハルト半島',isBoss:'小怪',mapWhere:['8198'],lessElem:'冰',moreElem:'None'},
]
var MB_value = [
    ...
    {pid:'8509',name:'炎角<br>炎角', monsKind:'ゴート系' ,spaceName:'バハマール高原',isBoss:'Boss',mapWhere:['8102'],showTime:'讨伐附近的同类型敌人<br>夜间<br>多人讨伐概率增加',level:'26'},
    ...
    {pid:'8521',name:'剛腕の覇者<br>刚腕的霸者', monsKind:'ドゴルマン系' ,spaceName:'エバーグリーン砂漠',isBoss:'Boss',mapWhere:['8114'],showTime:'讨伐附近的同类型敌人<br>多人讨伐概率增加',level:'48'},
    ...
    {pid:'8532',name:'荒ぶる牙王<br>狂暴牙王', monsKind:'ボア系' ,spaceName:'<a onclick="showFuBenWhereIs(1)">巨竜の爪痕・自由探索</a>',isBoss:'Boss',mapWhere:['8127'],showTime:'讨伐附近的同类型敌人',level:'49'},
    ...
    {pid:'8539',name:'朱に染まりし機神<br>朱红机神', monsKind:'ゴーレム系' ,spaceName:'<a onclick="showFuBenWhereIs(4)">枷神の産屋・自由探索</a>',isBoss:'Boss',mapWhere:['8132'],showTime:'讨伐附近的同类型敌人',level:'48'},
    {pid:'8540',name:'オメガファンクション<br>欧米茄函数', monsKind:'トライポッド系' ,spaceName:'<a onclick="showFuBenWhereIs(7)">風精の舞台・自由探索</a>',isBoss:'Boss',mapWhere:['8134'],showTime:'讨伐附近的同类型敌人',level:'48'},
    ...
    {pid:'8542',name:'剛禍の巨魁<br>刚祸之巨魁', monsKind:'ドゴルマン系' ,spaceName:'<a onclick="showFuBenWhereIs(8)">音無き都・自由探索</a>',isBoss:'Boss',mapWhere:['8136'],showTime:'讨伐附近的同类型敌人',level:'52'},
    {pid:'8543',name:'プロビデンスアイ<br>天佑之眼', monsKind:'スフィア系' ,spaceName:'<a onclick="showFuBenWhereIs(9)">機跡の谷・自由探索</a>',isBoss:'Boss',mapWhere:['8137'],showTime:'讨伐附近的同类型敌人',level:'51'},
    ...
    {pid:'8546',name:'潜む糸鋏<br>', monsKind:'カニクモ系' ,spaceName:'西バーンハルト半島',isBoss:'Boss',mapWhere:['8140'],showTime:'讨伐附近的同类型敌人',level:'54'},
    ...
    {pid:'8549',name:'精鋭騎士団員<br>精锐骑士团员', monsKind:'バーンハルト兵系' ,spaceName:'西バーンハルト半島',isBoss:'Boss',mapWhere:['8143'],showTime:'讨伐附近的同类型敌人',level:'55'},
    {pid:'8550',name:'幻妖乱破<br>幻妖乱破', monsKind:'カニクモ系' ,spaceName:'西バーンハルト半島',isBoss:'Boss',mapWhere:['8144'],showTime:'讨伐附近的同类型敌人',level:'58'},
    ...
    {pid:'8553',name:'キングムーク<br>穆库王', monsKind:'ムーク系' ,spaceName:'<a onclick="showFuBenWhereIs(12)">呪霊たちの棲家・自由探索</a>',isBoss:'Boss',mapWhere:['8147'],showTime:'讨伐附近的同类型敌人',level:'59'},
]