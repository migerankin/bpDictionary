...
var MB_value = [
    ...
    {pid:'8504',name:'深緑の牙<br>深绿的獠牙',spaceName:'アステリア平原',isBoss:'Boss',mapWhere:['8097'],showTime:'讨伐附件的同类型敌人<br>白天',level:'15'},
    {pid:'8505',name:'異国の山賊ネズミ<br>异国山贼・鼠',spaceName:'アステリア平原',isBoss:'Boss',mapWhere:['8098'],showTime:'讨伐附件的同类型敌人<br>夜间<br>打开假的掉落箱',level:'24'},
    ...
    {pid:'8508',name:'サファイアトロット<br>宝蓝色的急行',spaceName:'バハマール高原',isBoss:'Boss',mapWhere:['8101'],showTime:'讨伐附件的同类型敌人<br>白天<br>打开假的掉落箱',level:'16'},
    ...
    {pid:'8524',name:'サンドパイソン<br>沙蟒',spaceName:'エバーグリーン砂漠',isBoss:'Boss',mapWhere:['8117'],showTime:'讨伐附件的同类型敌人<br>夜间',level:'41'},
    {pid:'8525',name:'異国の山賊射手ヤマネコ<br>异国山贼射手・山猫',spaceName:'エバーグリーン砂漠',isBoss:'Boss',mapWhere:['8118'],showTime:'讨伐附件的同类型敌人<br>白天<br>打开假的掉落箱',level:'31'},
