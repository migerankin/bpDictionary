...
var B_value = [
    ...
    {pid:'5005',name:'タイラントボア<br>暴君野猪',element:'无',lev:'5',atk:'2',def:'4',j:'8',n:'10',q:'4',z:'6',s:'6',end:'勇猛G1<br>タフネスG1<br>刚力G1',endexp:'攻击力+10<br>筋力+3 耐久+3<br>筋力+5',cd:'60',skill:'使用獠牙挑击敌人，并为其施加恐惧状态',kind:'攻击',isJust:'0',madeIt:{tuzhi:'初始',sucai_Q:'ルーノ',sucai_Q_num:'1400',sucai_C:['水晶の原石','動的エングラム結晶片','長毛草'],sucai_C_num:[10,3,2],sucai_B:'タイラントボア',sucai_B_num:'1',otherWords:'アンドラ盆地（图一中上）'}},

    {pid:'5006',name:'ホーンゴート<br>霍恩羊',element:'无',lev:'10',atk:'4',def:'5',j:'8',n:'8',q:'11',z:'12',s:'8',end:'强击：远隔攻击・G1<br>气功G1<br>忍耐力G1',endexp:'远程攻击造成伤害+5%<br>耐久+3 器用+3<br>耐久+5',cd:'65',skill:'用后足蹄击敌人，并为其施加恐惧状态',kind:'攻击',isJust:'0',madeIt:{tuzhi:'初始',sucai_Q:'ルーノ',sucai_Q_num:'8800',sucai_C:['さざなみ石','動的エングラム結晶片','ゴブリンのたてがみ'],sucai_C_num:[3,10,1],sucai_B:'ホーンゴート',sucai_B_num:'1',otherWords:'鎮まりの山麓(图一右)'}},

    {pid:'5007',name:'カイザーエルク<br>凯撒麋鹿',element:'无',lev:'10',atk:'4',def:'4',j:'5',n:'15',q:'7',z:'13',s:'7',end:'强击：近接攻击・G1<br>トランスG1<br>博识G1',endexp:'近战造成伤害+5%<br>筋力+3 知力+3<br>知力+5',cd:'60',skill:'用鹿角撞击敌人，并为其施加恐惧状态',kind:'攻击',isJust:'0',madeIt:{tuzhi:'初始',sucai_Q:'ルーノ',sucai_Q_num:'8800',sucai_C:['動的エングラム結晶片','グロークンシード','ハイランドフォックスの牙'],sucai_C_num:[10,3,1],sucai_B:'カイザーエルク',sucai_B_num:'1',otherWords:'神の見守る丘（图一左下）'}},

    {pid:'5008',name:'赤い飛沫<br>赤红飞沫',element:'无',lev:'10',atk:'4',def:'4',j:'5',n:'15',q:'7',z:'13',s:'7',end:'气合奔流G1<br>ウィズダムG1<br>巧妙G1',endexp:'ST+5<br>器用+3 知力+3<br>器用+5',cd:'65',skill:'瞄准后用木棍击打敌人头部，并为其施加恐惧状态',kind:'攻击',isJust:'0',madeIt:{tuzhi:'初始',sucai_Q:'ルーノ',sucai_Q_num:'500',sucai_C:['動的エングラム結晶片','割れた貝殻','あかつき草'],sucai_C_num:[7,5,3],sucai_B:'赤い飛沫',sucai_B_num:'1',otherWords:''}},
    ...
    {pid:'5015',name:'深緑の牙<br>深绿的獠牙',element:'无',lev:'15',atk:'7',def:'5',j:'10',n:'16',q:'3',z:'17',s:'14',end:'急所感知G1<br>タフネスG1<br>刚力G1',endexp:'会心率+4%<br>筋力+3 耐久+3<br>筋力+5',cd:'95',skill:'向前突进攻击敌人，并为其施加眩晕状态、恐惧状态',kind:'攻击',isJust:'0',madeIt:{tuzhi:'初始',sucai_Q:'ルーノ',sucai_Q_num:'20000',sucai_C:['さざなみ石','動的エングラムの欠片','ゴブリンの棍棒'],sucai_C_num:[4,23,2], sucai_B:'深緑の牙',sucai_B_num:'1',otherWords:''}},
    ...
    {pid:'5017',name:'スプーキーゴート<br>幽灵山羊',element:'无',lev:'20',atk:'7',def:'9',j:'21',n:'11',q:'9',z:'18',s:'18',end:'勇猛G1<br>エキスパートG1<br>刚力G1',endexp:'攻击力+10<br>筋力+3 器用+3<br>筋力+5',cd:'70',skill:'大声鸣叫，一定时间内为自身付与移动速度提升・中状态',kind:'辅助',isJust:'0',madeIt:{tuzhi:'初始',sucai_Q:'ルーノ',sucai_Q_num:'47500',sucai_C:['動的エングラム結晶片','割れた貝殻','静夜鉱'],sucai_C_num:[12,5,3],sucai_B:'スプーキーゴート',sucai_B_num:'1',otherWords:''}},

    {pid:'5018',name:'サンドバイパー<br>白蝰蛇',element:'无',lev:'20',atk:'7',def:'7',j:'14',n:'19',q:'20',z:'15',s:'8',end:'强击：通常攻击・G1<br>气功G1<br>忍耐力G1',endexp:'普通攻击造成伤害+7%<br>耐久+3 器用+3<br>耐久+5',cd:'80',skill:'咬向敌人，并为其施加麻痹状态',kind:'攻击',isJust:'0',madeIt:{tuzhi:'初始',sucai_Q:'ルーノ',sucai_Q_num:'500',sucai_C:['動的エングラムの欠片','グロークンシード','ランドホークの鉤爪'],sucai_C_num:[10,3,1],sucai_B:'サンドバイパー',sucai_B_num:'1',otherWords:'オルビド平野（图一左）'}},

    {pid:'5019',name:'ネコ<br>猫',element:'无',lev:'20',atk:'7',def:'8',j:'15',n:'19',q:'19',z:'6',s:'18',end:'生命奔流G1<br>ウィズダムG1<br>巧妙G1',endexp:'HP+100<br>器用+3 知力+3<br>器用+5',cd:'65',skill:'梳理毛发，在一定时间内为自身付与受到伤害减少・中状态',kind:'辅助',isJust:'0',madeIt:{tuzhi:'初始',sucai_Q:'ルーノ',sucai_Q_num:'47500',sucai_C:['動的エングラムの欠片','トコヨ草'],sucai_C_num:[10,9],sucai_B:'ネコ',sucai_B_num:'',otherWords:'完成任务「ネコネコ大集合」'}},
    ...
    {pid:'5024',name:'炎角<br>炎角',element:'火',lev:'30',atk:'9',def:'13',j:'28',n:'21',q:'24',z:'24',s:'2',end:'强击：Bイマジン・G1<br>トランスG2<br>刚力G2',endexp:'战斗幻想伤害+6%<br>筋力+7 知力+7<br>筋力+13',cd:'65',skill:'向前行进对敌人造成火属性伤害，并为其施加恐惧状态',kind:'攻击',isJust:'0',madeIt:{tuzhi:'初始',sucai_Q:'ルーノ',sucai_Q_num:'158600',sucai_C:['ホーンゴートの角','動的エングラムの欠片','環状石'],sucai_C_num:[3,59,3],sucai_B:'炎角',sucai_B_num:'1',otherWords:''}},

    {pid:'5025',name:'ランドホーク<br>鹞',element:'无',lev:'30',atk:'12',def:'10',j:'16',n:'15',q:'18',z:'24',s:'26',end:'气合奔流G1<br>シックスセンスG2<br>博识G2',endexp:'ST+5<br>知力+7 精神+7<br>知力+15',cd:'60',skill:'在空中滑行向敌人冲刺进行攻击，并为其施加恐惧状态',kind:'攻击',isJust:'0',madeIt:{tuzhi:'初始',sucai_Q:'ルーノ',sucai_Q_num:'158600',sucai_C:['環状石','動的エングラムの欠片','山賊の射手のズボン'],sucai_C_num:[3,10,1],sucai_B:'ランドホーク',sucai_B_num:'1',otherWords:'陽炎の谷（图一左下）'}},
    ...
    {pid:'5037',name:'アインレインα<br>爱因莱因α',element:'冰',lev:'40',atk:'19',def:'10',j:'9',n:'18',q:'31',z:'31',s:'36',end:'ウィズダムG2',endexp:'器用+7 知力+7',cd:'65',skill:'生成一个能够抵御远程伤害的防御屏障，并为屏障中的友方角色付与伤害减免・中状态',kind:'辅助',isJust:'0',madeIt:{tuzhi:'初始',sucai_Q:'ルーノ',sucai_Q_num:'1000',sucai_C:['-'],sucai_C_num:[2,2],sucai_B:'アインレインα',sucai_B_num:'',otherWords:'通行证六十级'}},

    {pid:'5038',name:'カガチヤンマ<br>灰卡伽蜻蜓',element:'无',lev:'40',atk:'15',def:'11',j:'21',n:'35',q:'21',z:'31',s:'23',end:'强击：远隔攻击・G1<br气功G2<br集中G2',endexp:'战远程攻击造成伤害+5%<br>耐久+7 器用+7<br>精神+13',cd:'80',skill:'发射睡眠弹，并未命中的敌人施加睡眠状态',kind:'攻击',isJust:'0',madeIt:{tuzhi:'初始',sucai_Q:'ルーノ',sucai_Q_num:'293000',sucai_C:['さざなみ石','動的エングラムの欠片','ナッポの扇葉'],sucai_C_num:[3,10,1],sucai_B:'カガチヤンマ',sucai_B_num:'2',otherWords:'ガレィリッジ廃道（图一左下）'}},
    ...
    {pid:'5042',name:'サンドパイソン<br>沙蟒',element:'土',lev:'40',atk:'12',def:'13',j:'26',n:'18',q:'16',z:'34',s:'40',end:'ジャストカウンターG1<br>气功G2<br>巧妙G2',endexp:'提高闪避攻击造成的伤害+6%<br>耐久+7 器用+7<br>器用+13',cd:'65',skill:'施展咆哮，对周围敌人造成土属性伤害，并为其施加恐惧状态',kind:'攻击',isJust:'0',madeIt:{tuzhi:'初始',sucai_Q:'ルーノ',sucai_Q_num:'293000',sucai_C:['動的エングラムの欠片','グロークンシード','山賊の斥候の上着'],sucai_C_num:[69,3,3],sucai_B:'サンドパイソン',sucai_B_num:'1',otherWords:''}},

    {pid:'5043',name:'ドゴルマン<br>多古尔曼兽',element:'无',lev:'40',atk:'13',def:'14',j:'31',n:'16',q:'31',z:'21',s:'31',end:'痛击G1<br>エキスパートG2<br>刚力G2',endexp:'会心力+12<br>筋力+7 器用+7<br>筋力+13',cd:'65',skill:'跳跃后锤击地面，攻击敌人并为其施加恐惧状态',kind:'攻击',isJust:'0',madeIt:{tuzhi:'初始',sucai_Q:'ルーノ',sucai_Q_num:'293000',sucai_C:['さざなみ石','動的エングラムの欠片','オオカガチヤンマの立派な殻'],sucai_C_num:[3,10,1],sucai_B:'ドゴルマン',sucai_B_num:'2',otherWords:'帰らずの砂塵（图一）'}},
    ...
    {pid:'5056',name:'アインレインβ<br>爱因莱因β',element:'冰',lev:'50',atk:'22',def:'12',j:'32',n:'3',q:'38',z:'45',s:'38',end:'气合奔流G1',endexp:'ST+5',cd:'70',skill:'在原地生成领域并进行攻击，为敌人施加受到伤害增加・小状态、冰属性耐性下降・小状态、移动速度下降・小状态降低',kind:'攻击',isJust:'0',madeIt:{tuzhi:'初始',sucai_Q:'ルーノ',sucai_Q_num:'1000',sucai_C:['-'],sucai_C_num:[],sucai_B:'アインレインβ',sucai_B_num:'',otherWords:'付费通行证满级奖励'}},
    ...
    {pid:'5058',name:'*貝殻ゴブリン<br>*贝壳哥布林',element:'火',lev:'15',atk:'6',def:'6',j:'12',n:'13',q:'12',z:'12',s:'12',end:'生命奔流G1<br>トランスG1<br>刚力G1',endexp:'HP+100<br>筋力+3 知力+3<br>筋力+5',cd:'90',skill:'挥舞火把进行火属性攻击，并为敌人施加眩晕状态',kind:'攻击',isJust:'1',madeIt:{tuzhi:'初始',sucai_Q:'ルーノ',sucai_Q_num:'293000',sucai_C:['-'],sucai_C_num:[2,2],sucai_B:'*貝殻ゴブリン',sucai_B_num:'1',otherWords:'フィエル嶺水池（图二左）'}},
