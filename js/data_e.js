...
var E_value = [
    ...
    {pid:'0003',name:'神託の乙女<br>神谕少女',kind:'三叶',lev:'15',atk:'4',def:'5',j:'12',n:'13',q:'11',z:'1',s:'8',end:'防御的极意：光属性攻击・G1<br>气合奔流G1<br>集中G1',endexp:'光属性受伤减免+8%<br>ST+5<br>精神+5',isJust:'0',madeIt:{tuzhi:'角色任务「神託の巫女」',sucai_Q:'ルーノ',sucai_Q_num:'20000',sucai_C:['動的エングラムの結晶片','割れた貝殻','メリソス石灰石'],sucai_C_num:[8,5,3],sucai_B:'',sucai_B_num:''}},
    ...
    {pid:'0006',name:'手作りの価値<br>手工的价值',kind:'三叶',lev:'25',atk:'5',def:'11',j:'16',n:'17',q:'9',z:'7',s:'16',end:'防御的极意：土属性攻击・G1<br>トランスG2<br>忍耐力G2',endexp:'土属性受伤减免+8%<br>筋力+7 知力+7<br>耐久+13',isJust:'0',madeIt:{tuzhi:'角色任务「手作りの価値」',sucai_Q:'ルーノ',sucai_Q_num:'95800',sucai_C:['水晶の原石','動的エングラムの結晶片','砂蝋枝'],sucai_C_num:[10,16,3],sucai_B:'',sucai_B_num:''}},
    ...
    {pid:'0013',name:'*視線も集めております<br>*目不转睛',kind:'三叶',lev:'15',atk:'2',def:'7',j:'12',n:'8',q:'9',z:'5',s:'11',end:'シックスセンスG1<br>巧妙G1<br>防御的极意：土属性攻击・G1',endexp:'知力+3 精神+3<br>器用+5<br>土属性受伤减免+8%',isJust:'1',madeIt:{tuzhi:'2023夏活4500个贝壳道具交换',sucai_Q:'-',sucai_Q_num:'-',sucai_C:['動的エングラムの結晶片','トコヨ草'],sucai_C_num:[8,10],sucai_B:'',sucai_B_num:''}},
    ...
    {pid:'1003',name:'神に守られし土地<br>神佑的土地',kind:'山岳',lev:'10',atk:'2',def:'4',j:'4',n:'8',q:'5',z:'7',s:'5',end:'耐雷心得G3<>タフネスG1<>博识G1',endexp:'雷属性耐性+10<br>筋力+3 耐久+3<br>知力+5',isJust:'0',madeIt:{tuzhi:'冒险者任务板・四',sucai_Q:'ルーノ',sucai_Q_num:'8800',sucai_C:['水晶の原石','動的エングラムの結晶片','煙霧苔'],sucai_C_num:[10,7,3],sucai_B:'',sucai_B_num:''}},
    ...
    {pid:'1005',name:'目指すはオアシス<br>目光尽头的绿洲',kind:'山岳',lev:'20',atk:'4',def:'9',j:'8',n:'12',q:'13',z:'14',s:'6',end:'短缩：ULTG1<br>不屈G2<br>巧妙G2',endexp:'大招冷却缩减+4%<br>防御+40<br>器用+13',isJust:'0',madeIt:{tuzhi:'冒险者任务板・七',sucai_Q:'ルーノ',sucai_Q_num:'20000',sucai_C:['動的エングラムの結晶片','割れた貝殻','雨唄いの化石'],sucai_C_num:[12,5,3],sucai_B:'',sucai_B_num:''}},

    {pid:'1006',name:'お姉様へ……<br>温柔的大姐姐……',kind:'山岳',lev:'25',atk:'4',def:'12',j:'13',n:'8',q:'16',z:'16',s:'13',end:'短缩：クラスAG1<br>シックスセンスG2<br>刚力G2',endexp:'クラスアクション间隔缩短+6%<br>知力+7 精神+7<br>筋力+13',isJust:'0',madeIt:{tuzhi:'角色任务「お姉様へ……」',sucai_Q:'ルーノ',sucai_Q_num:'95800',sucai_C:['動的エングラムの結晶片','トコヨ草','砂ミミズ'],sucai_C_num:[16,10,3],sucai_B:'',sucai_B_num:''}},
    ...
    {pid:'2003',name:'ティリスの趣味<br>提莉丝的嗜好',kind:'矢尻',lev:'15',atk:'2',def:'7',j:'9',n:'8',q:'13',z:'14',s:'0',end:'スタミナセーブ：走・G1<br>トランスG1<br>巧妙G1',endexp:'冲刺体力减免+10%<br>筋力+3 知力+3<br>器用+5',isJust:'0',madeIt:{tuzhi:'角色任务「ティリスの趣味」',sucai_Q:'ルーノ',sucai_Q_num:'20000',sucai_C:['動的エングラムの結晶片','トコヨ草','モンテノールストーン'],sucai_C_num:[8,10,3],sucai_B:'',sucai_B_num:''}},
    ...
    {pid:'2005',name:'乾いた風の終点<br>干风燥沙的终点',kind:'矢尻',lev:'20',atk:'5',def:'8',j:'13',n:'12',q:'10',z:'4',s:'14',end:'耐土心得G3<br>屈强的心身G2<br>刚力G2',endexp:'土属性耐性+10<br>耐久+7 精神+7<br>筋力+13',isJust:'0',madeIt:{tuzhi:'冒险者任务板・七',sucai_Q:'ルーノ',sucai_Q_num:'47500',sucai_C:['水晶の原石','動的エングラムの結晶片','レインフォールハーブ'],sucai_C_num:[10,12,3],sucai_B:'',sucai_B_num:''}},
    ...
    {pid:'2007',name:'守りたい未来<br>想要守护的未来',kind:'矢尻',lev:'30',atk:'5',def:'14',j:'15',n:'18',q:'19',z:'6',s:'18',end:'气合奔流G1<br>トランスG2<br>巧妙G2',endexp:'ST+5<br>筋力+7 知力+7<br>器用+13',isJust:'0',madeIt:{tuzhi:'角色任务「守りたい未来」',sucai_Q:'ルーノ',sucai_Q_num:'162200',sucai_C:['水晶の原石','動的エングラムの結晶片','風の這痕'],sucai_C_num:[10,20,3],sucai_B:'',sucai_B_num:''}},
    ...
    {pid:'2011',name:'*花火を楽しむなら夜なのじゃ<br>*夜幕降临・烟花盛放之时',kind:'矢尻',lev:'15',atk:'3',def:'6',j:'7',n:'4',q:'10',z:'11',s:'12',end:'ウィズダムG1<br>集中G1<br>防御的极意：冰属性攻击・G1',endexp:'器用+3 知力+3<br>精神+5<br>冰属性受伤减免+8%',isJust:'1',madeIt:{tuzhi:'2023夏活4500个贝壳道具交换',sucai_Q:'ルーノ',sucai_Q_num:'待补充',sucai_C:['-'],sucai_C_num:[2,2],sucai_B:'',sucai_B_num:''}},

    {pid:'2012',name:'*貝殻ゴブリンがやってきた<br>*贝壳哥布林堂堂驾到',kind:'矢尻',lev:'15',atk:'4',def:'5',j:'9',n:'10',q:'8',z:'11',s:'6',end:'不屈G1<br>エキスパートG1<br>刚力G1',endexp:'防御力+15<br>筋力+3 器用+3<br>筋力+5',isJust:'1',madeIt:{tuzhi:'2023夏活4500个贝壳道具交换',sucai_Q:'ルーノ',sucai_Q_num:'待补充',sucai_C:['-'],sucai_C_num:[2,2],sucai_B:'',sucai_B_num:''}},


    ///////////////
    //  风车
    ////////////////
    {pid:'3001',name:'フェステのこと<br>关于菲丝特',kind:'风车',lev:'5',atk:'2',def:'1',j:'4',n:'6',q:'4',z:'5',s:'2',end:'气合奔流G1<br>不屈G1<br>刚力G1',endexp:'ST+5<br>防御力+15<br>筋力+5',isJust:'0',madeIt:{tuzhi:'角色任务「フェステのこと」',sucai_Q:'ルーノ',sucai_Q_num:'1400',sucai_C:['動的エングラムの結晶片','ジラ輝石','割れた貝殻'],sucai_C_num:[3,2,4],sucai_B:'',sucai_B_num:''}},
    ...
    //  水瓶
    ////////////////
    {pid:'4001',name:'巨竜の爪痕の主・荒ぶる牙王<br>巨龙爪痕之主・狂暴牙王',kind:'水瓶',lev:'10',atk:'3',def:'3',j:'5',n:'7',q:'7',z:'9',s:'1',end:'不屈G1<br>シックスセンスG1<br>刚力G1',endexp:'防御力+15<br>知力+3 精神+3<br>筋力+5',isJust:'0',madeIt:{tuzhi:'冒险者任务板・四',sucai_Q:'ルーノ',sucai_Q_num:'8800',sucai_C:['水晶の原石','動的エングラムの結晶片','リュウノツメモドキ'],sucai_C_num:[10,7,3],sucai_B:'',sucai_B_num:''}},
    ...
    {pid:'4003',name:'交易商の通い道<br>商贸旅道',kind:'水瓶',lev:'15',atk:'4',def:'5',j:'8',n:'10',q:'6',z:'9',s:'11',end:'耐光心得G3<br>エキスパートG1<br>忍耐力G1',endexp:'光属性耐性+10<br>筋力+3 器用+3<br>耐久+5',isJust:'0',madeIt:{tuzhi:'冒险者任务板・五',sucai_Q:'ルーノ',sucai_Q_num:'20000',sucai_C:['環状石','動的エングラムの結晶片','カニクモの爪'],sucai_C_num:[5,23,3],sucai_B:'',sucai_B_num:''}},

    {pid:'4004',name:'ムークの縄張り<br>穆库的领地',kind:'水瓶',lev:'15',atk:'5',def:'5',j:'14',n:'10',q:'4',z:'6',s:'12',end:'防御的极意：雷属性攻击・G1<br>生命奔流G1<br>巧妙G1',endexp:'雷属性受伤减免+8%<br>HP+100<br>器用+5',isJust:'0',madeIt:{tuzhi:'冒险者任务板・五',sucai_Q:'ルーノ',sucai_Q_num:'20000',sucai_C:['水晶の原石','動的エングラムの結晶片','リッツェホーンウッド'],sucai_C_num:[10,8,3],sucai_B:'',sucai_B_num:''}},
    ...
    {pid:'4006',name:'贈りものの相手は<br>致礼物收件人',kind:'水瓶',lev:'25',atk:'4',def:'12',j:'8',n:'9',q:'16',z:'16',s:'16',end:'スタミナセーブ：跳・・G1<br>ウィズダムG2<br>博识G2',endexp:'跳跃体力减免+10%<br>器用+7 知力+7<br>知力+13',isJust:'0',madeIt:{tuzhi:'角色任务「贈りものの相手は」',sucai_Q:'ルーノ',sucai_Q_num:'95800',sucai_C:['動的エングラムの結晶片','トコヨ草','谷底白砂'],sucai_C_num:[16,10,3],sucai_B:'',sucai_B_num:''}},
