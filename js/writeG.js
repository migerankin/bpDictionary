...
function writeG(){
    ...
    var Ghtml = `<div class="mainPic" style="background: linear-gradient(rgba(255, 255, 255, 0), rgba(0, 0, 0, 0.2)), url(https://migerankin.github.io/bpDictionary/img/pagemain${(Math.floor(Math.random() * 3)+1)}.png) 80% 40%;background-size: 100% auto;"></div>
